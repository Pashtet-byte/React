/* =========================================================
   ...
   «Основы современного JavaScript для React»
   ========================================================= */
...
/* =========================================================
   Бонус: безопасные операторы (optional chaining, nullish coalescing)
   — упомянуты в описании работы («безопасные операторы»)
   ========================================================= */
